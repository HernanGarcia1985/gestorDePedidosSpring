  ...
  return (
    ...
    <Form >
        ...
        <Form.Group className="mb-3">
            ...
            <Form.Control defaultValue={basePrice} onChange={(e) => { setBasePrice(e.target.value)}}/>
        </Form.Group>
        <Row>
            <Col md-auto>
                <Form.Group className="mb-3">
            ...
            <Col>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control defaultValue={supportCharge} onChange={(e) => { setSupportCharge(e.target.value)}}/>
                </Form.Group>
            </Col>
        </Row>
        <Row>
            <Col>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control defaultValue={warrantyPercentage} onChange={(e) => { setWarrantyPercentage(e.target.value)}}/>
                </Form.Group>
            </Col>
        </Row>    
        <Form.Group className="mb-3">
